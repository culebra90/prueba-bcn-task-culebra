...
describe('API Tests', () => {
  ...
  it('Procesar OK Imagenes por path de sistema de archivos y guardaralas en la carpeta output - local', async () => {
  ...
  it('Procesar OK Imagenes por path de sistema de archivos y guardaralas en la carpeta output - nube', async () => {
