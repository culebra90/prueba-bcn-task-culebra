...
describe('API Tests', () => {
  it('Procesar OK Imagenes por path de sistema de archivos y subirlas a la nube', async () => {
    const response = await request(task)
      .post('/task')
      .set('Content-Type', 'application/json')
      .send({ path: '/images/background-capitole.jpg' })
      .expect(200);
  ...
  it('Procesar OK Imagenes por path de sistema de archivos y guardaralas en la carpeta output - en local', async () => {
  ...
  it('Procesar OK Imagenes por path de sistema de archivos y guardaralas en la carpeta output - en nube', async () => {
